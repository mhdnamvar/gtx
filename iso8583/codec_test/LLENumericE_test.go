...
func TestLLENumericE_Encode(t *testing.T) {
	value := "1234567890"
	expected := []byte{0xF1, 0xF0, 0xF1, 0xF2, 0xF3, 0xF4, 0xF5, 0xF6, 0xF7, 0xF8, 0xF9, 0xF0}
	c := codec.DefaultLLENumericE(10)
	actual, err := c.Encode(value)
	assert.Equal(t, nil, err)
	assert.Equal(t, expected, actual)
}

func TestLLENumericE_Encode_LeftPad(t *testing.T) {
	value := "12345678"
	expected := []byte{0xF1, 0xF0, 0xF0, 0xF0, 0xF1, 0xF2, 0xF3, 0xF4, 0xF5, 0xF6, 0xF7, 0xF8}
	c := codec.DefaultLLENumericE(10)
...
func TestLLENumericE_Encode_RightPad(t *testing.T) {
	value := "12345678"
	expected := []byte{0xF1, 0xF0, 0xF1, 0xF2, 0xF3, 0xF4, 0xF5, 0xF6, 0xF7, 0xF8, 0xF0, 0xF0}
	c := codec.DefaultLLENumericE(10)
...
func TestLLENumericE_Encode_InvalidLen(t *testing.T) {
	value := "iso8583"
	c := codec.DefaultLLENumericE(10)
	actual, err := c.Encode(value)
...
func TestLLENumericE_Decode(t *testing.T) {
...
func TestLLENumericE_Decode_InvalidLen(t *testing.T) {
	value := []byte{0xF1, 0xF0, 0xF1, 0xF2, 0xF3, 0xF4, 0xF5, 0xF6, 0xF7, 0xC1, 0xC2, 0xC3}
	c := codec.DefaultLLENumericE(11)
	actual, _, err := c.Decode(value)
...
func TestLLENumericE_Decode_LeftPad(t *testing.T) {
...
func TestLLENumericE_Decode_LeftPad_InvalidData(t *testing.T) {
...
func TestLLENumericE_Decode_RightPad_InvalidData(t *testing.T) {
