...
func TestIsoLLANumericA_Encode(t *testing.T) {
	value := "1234567890"
...
func TestIsoLLANumericA_Encode_LeftPad(t *testing.T) {
	value := "12345678"
...
func TestIsoLLANumericA_Encode_RightPad(t *testing.T) {
	value := "12345678"
...
func TestIsoLLANumericA_Encode_InvalidLen(t *testing.T) {
	value := "iso8583"
	codec := DefaultLLANumericA(10)
	actual, err := codec.Encode(value)
...
func TestIsoLLANumericA_Decode(t *testing.T) {
...
func TestIsoLLANumericA_Decode_InvalidLen(t *testing.T) {
	value := []byte{0x31, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x41, 0x42, 0x43}
...
func TestIsoLLANumericA_Decode_LeftPad(t *testing.T) {
...
func TestIsoLLANumericA_Decode_LeftPad_InvalidLen(t *testing.T) {
...
func TestIsoLLANumericA_Decode_RightPad_InvalidLen(t *testing.T) {
