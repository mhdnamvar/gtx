...
func TestIsoStringB_Encode(t *testing.T) {
...
func TestIsoStringB_Encode_LeftPad(t *testing.T) {
	value := "2D2A98F12D2A9820"
...
func TestIsoStringB_Encode_RightPad(t *testing.T) {
	value := "2D2A98F12D2A9820"
...
func TestIsoStringB_Encode_InvalidData(t *testing.T) {
...
func TestIsoStringB_Encode_InvalidLen(t *testing.T) {
...
func TestIsoStringB_Decode(t *testing.T) {
...
func TestIsoStringB_Decode_InvalidLen(t *testing.T) {
	value := []byte{0x2D, 0x2A, 0x98, 0xF1, 0x2D, 0x2A, 0x98, 0x20, 0x12, 0x34, 0x56}
...
func TestIsoStringB_Decode_LeftPad(t *testing.T) {
...
func TestIsoStringB_Decode_RightPad(t *testing.T) {
...
func TestIsoStringB_Decode_LeftPad_InvalidLen(t *testing.T) {
...
func TestIsoStringB_Decode_RightPad_InvalidLen(t *testing.T) {
	value := []byte{0x20, 0x20, 0x2D, 0x2A, 0x98}
	codec := DefaultIsoStringB(6)
	codec.PaddingType = IsoRightPadding
	actual, _, err := codec.Decode(value)
