...
func Test_LLBBinary_EncodePad(t *testing.T) {
	...
	codec := LLBBinaryNew("", "Should be [0x08, 0x00, 0x2D, 0x2A, 0x98, 0xF1, 0x2D, 0x2A, 0x98]", 8, true)
...
func Test_LLBBinary_EncodeNoPad(t *testing.T) {
	...
	codec := LLBBinaryNew("", "Should be [0x08, 0x2D, 0x2A, 0x98, 0xF1, 0x2D, 0x2A, 0x98, 0xF1]", 11, false)
	actual, err := codec.Encode(value)
	assertEqual(t, nil, err)
	assertEqual(t, expected, actual)
}
...
func Test_LLBBinary_EncodeInvalidLen(t *testing.T) {
	value := "2D2A98F12D"
	codec := LLBBinaryNew("", "Should return error", 4, true)
	actual, err := codec.Encode(value)
...
func Test_LLBBinary_Decode(t *testing.T) {
	...
	codec := LLBBinaryNew("", "Should be 2D2A98F12D2A98F1", 8, true)
...
func Test_LLBBinary_DecodeError(t *testing.T) {
	...
	codec := LLBBinaryNew("", "Should return error", 10, true)
	actual, err := codec.Decode(value)
	assertEqual(t, Errors[InvalidLengthError], err)
	assertEqual(t, nil, actual)
}
