...
func Test_LLANumeric_Encode(t *testing.T) {
	...
	codec := LLANumericNew("", "Should be 0512345", 11, false)
...
func Test_LLANumeric_EncodePad(t *testing.T) {
	...
	codec := LLANumericNew("", "Should be 1100000012345", 11, true)
	actual, err := codec.Encode(value)
	assertEqual(t, nil, err)
	assertEqual(t, expected, actual)

	expected = []byte("09000012345")
	codec = LLANumericNew("", "Should be 1100000012345", 9, true)
	actual, err = codec.Encode(value)
	assertEqual(t, nil, err)
	assertEqual(t, expected, actual)
}
...
func Test_LLANumeric_InvalidLen(t *testing.T) {
	value := "123456789012"
	codec := LLANumericNew("", "Should return error", 11, false)
	actual, err := codec.Encode(value)
...
func Test_LLANumeric_InvalidFormat(t *testing.T) {
	value := "1234567890A"
	codec := LLANumericNew("", "Should return nil, error", 11, false)
	actual, err := codec.Encode(value)
...
func Test_LLANumeric_Decode(t *testing.T) {
	...
	expected := "1234567890"
	codec := LLANumericNew("", "Should be 1234567890", 10, false)
...
func Test_LLANumeric_DecodeInvalidLen(t *testing.T) {
	...
	codec := LLANumericNew("", "Should return error", 10, false)
	actual, err := codec.Decode(value)
	assertEqual(t, Errors[InvalidLengthError], err)
	assertEqual(t, nil, actual)
}
...
func Test_LLANumeric_DecodePad(t *testing.T) {
	...
	expected := "0001234567"
	codec := LLANumericNew("", "Should be 0001234567", 10, true)
	actual, err := codec.Decode(value)
	assertEqual(t, nil, err)
	assertEqual(t, expected, actual)
}
