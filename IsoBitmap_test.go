...
func TestIsoBitmapStringPrimary(t *testing.T) {
	...
	bitmap.Set(2, 12)
	assertEqual(t, "4010000000000000", bitmap.String())
}

func TestIsoBitmapArrayPrimary(t *testing.T) {
	var bitmap IsoBitmap
	bitmap.Set(2, 12)
	assertEqual(t, []int{2, 12}, bitmap.Array())
}
...
func TestIsoBitmapParsePrimary(t *testing.T) {
	...
	assertEqual(t, []int{2, 3, 4, 6, 7, 10, 11, 12, 13, 14, 15, 16, 18,
...
func TestIsoBitmapStringSecondary(t *testing.T) {
	...
	assertEqual(t, "E0000200100000018000004000000001", bitmap.String())
}

func TestIsoBitmapArraySecondary(t *testing.T) {
	var bitmap IsoBitmap
	bitmap.Set(2, 3, 23, 36, 64, 65, 90, 128)
	assertEqual(t, []int{1, 2, 3, 23, 36, 64, 65, 90, 128}, bitmap.Array())
}
...
func TestIsoBitmapClear(t *testing.T) {
	...
	assertEqual(t, "6000000000000000", bitmap.String())
	bitmap.Clear(2, 3)
	assertEqual(t, "0000000000000000", bitmap.String())
}